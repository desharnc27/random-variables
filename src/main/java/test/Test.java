...
public class Test {
    ...
    public static void main1() {
        ...
        System.out.println(ds.compareAnalyticCumulativeToSample(ends,25,0.02));
        ds.compareAnalyticToSample(277);
        /*for (int i = 0;i<10;i++){
    ...
    public static void main(String[] args) {
        System.out.println(MiscFunctions.studentCumulativeApprox(0.3,29));
        //main1();
    }
